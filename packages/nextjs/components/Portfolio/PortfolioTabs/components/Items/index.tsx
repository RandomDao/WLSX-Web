...
export const Items = ({ userInfo, queryUserInfo, checkSumAddress }: any) => {
      ...
      <div className="px-[45px] py-[49px] pt-[26px]">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-[51px]">
            <div className="flex items-center gap-[14px]">
              <div className="text-[14px] font-Gotham">Only show claimable</div>
              <div>
        ...
        <div className="mt-[33px]">
          ...
          >
            ...
            <div className="w-[235px]">Face value per item</div>
            <div className="w-[135px]">Quantity</div>
            <div className="w-[192px]">Maturity</div>
          ...
          <div className="mt-[12px] flex flex-col gap-[9px]">
            {list.map((item, key) => (
              ...
              >
                ...
                <div className="w-[135px]">Quantity</div>
                <div className="w-[192px]">Maturity</div>
                <div className="w-[114px] text-right pr-[30px]">
                  <div className="cursor-pointer w-[114px] h-[46px] bg-[rgba(255,255,255,1)] rounded-[40px] flex justify-center items-center text-[14px] text-[rgba(61,55,99,1)] font-GothamBold ">
                    Claimed
                  </div>
                </div>
              </div>
